...
# Map fcyl to size
plt_mpg_vs_wt +
geom_point(mapping = aes(size = fcyl))
...
ggplot(mtcars, mapping = aes(mpg, qsec, color = fcyl)) + geom_point()
...
# Plot base
plt_mpg_vs_fcyl_by_fam <- ggplot(mtcars, aes(x = fcyl, y = mpg, color = fam))
...
ggplot(Vocab, mapping = aes(x = education, y = vocabulary)) +
  # Add a point layer
geom_point()
...
ggplot(economics, mapping = aes(date, unemploy/pop)) +
geom_line()

# Plot the Rainbow Salmon time series
ggplot(fish.species, mapping = aes(x = Year, y = Rainbow)) +
  geom_line()
