...
fair_14/sum(fair_14, high_14, low_14)
...
probability_fair/sum(probability_fair, probability_biased)
...
probability_fair_18 <- dbinom(18, 20, .5)
probability_biased_18 <- dbinom(18, 20, .75)
